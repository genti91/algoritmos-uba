...
static void prueba_abb_insertar()
{
    ...
    print_test("Prueba abb la cantidad de elementos es 2", abb_cantidad(abb) == 1);
    print_test("Prueba abb pertenece clave2, es true", abb_pertenece(abb, clave2));
    print_test("Prueba abb obtener clave2 es valor2", abb_obtener(abb, clave2) == valor2);
    print_test("Prueba abb obtener clave2 es valor2", abb_obtener(abb, clave2) == valor2);

    print_test("Prueba abb insertar lave3", abb_guardar(abb, clave3, valor3));
    print_test("Prueba abb la cantidad de elementos es 3", abb_cantidad(abb) == 2);
...
static void prueba_abb_volumen(size_t largo, bool debug)
{
    ...
    char* temporal = malloc(largo_clave);

    for (size_t i = 0; i < largo; i++) {
        size_t indice_aleatorio = rango_aleatorio(0, largo - 1);
        if (strcmp(claves[i], claves[indice_aleatorio])){
            strcpy(temporal, claves[i]);
            strcpy(claves[i], claves[indice_aleatorio]);
            strcpy(claves[indice_aleatorio], temporal);
        }
    }
    ...
    ok = true;
    for (size_t i = 0; i < largo; i++) {
        ok = abb_guardar(abb1, claves[i], valores[i]);
        if (!ok) break;
    }
    free(claves);
...
bool sumar_uno_a_todos(const char *clave, void *elemento, void *extra) {
    ++*((int*)elemento);
    return true;
}

bool sumar_a_especifico(const char *clave, void *elemento, void *extra) {
    if (!strcmp(clave, (char*)extra)) {
        ++*((int*)elemento);
        return false;
    }
    return true;
...
bool sumar_hasta_especifico(const char *clave, void *elemento, void *extra) {
    ++*((int*)elemento);
    if (!strcmp(clave, (char*)extra)) {
        return false;
    }
...
static void prueba_iter_interno_sin_corte(void){
    abb_t* abb = abb_crear(strcmp, free);
    print_test("La abb fue creada", abb != NULL);
    char *clave1 = "perr";
    char *clave2 = "gato";
    char *clave3 = "vaca";
    char *clave4 = "toro";
    ...
    *valor4 = 4;
    ...
    abb_in_order(abb, sumar_uno_a_todos, NULL);
    print_test("Se le sumo uno a todos", *(int*)abb_obtener(abb, clave1) == 2 && *(int*)abb_obtener(abb, clave3) == 4);
    abb_in_order(abb, sumar_uno_a_todos, NULL);
    print_test("Se le sumo uno a todos", *(int*)abb_obtener(abb, clave1) == 3 && *(int*)abb_obtener(abb, clave3) == 5);
    abb_destruir(abb);
}
...
static void prueba_iter_interno_con_corte(void){
    ...
    *valor4 = 4;
    ...
    abb_guardar(abb, clave3, valor3);
    abb_guardar(abb, clave4, valor4);
    abb_in_order(abb, sumar_a_especifico, clave3);
    print_test("Se le sumo uno a clave3", *(int*)abb_obtener(abb, clave3) == 4);
    abb_in_order(abb, sumar_a_especifico, clave2);
    print_test("Se le sumo uno a clave2", *(int*)abb_obtener(abb, clave2) == 3);
    abb_in_order(abb, sumar_hasta_especifico, clave3);
    print_test("Se le sumo uno hasta clave3", *(int*)abb_obtener(abb, clave3) == 5 && *(int*)abb_obtener(abb, clave4) == 4);
    abb_in_order(abb, sumar_hasta_especifico, clave3);
    print_test("Se le sumo uno hasta clave3", *(int*)abb_obtener(abb, clave3) == 6 && *(int*)abb_obtener(abb, clave4) == 4);
    abb_destruir(abb);
}
